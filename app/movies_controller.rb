...
def can_be_found_updated_and_saved
  ...
  flick = Movie.all.find_by(title: "Awesome Flick")
...
def can_update_using_update_method
  ...
  flick = Movie.all.find_by(title: "Wat?")
...
def can_destroy_a_single_item
  ...
  flick = Movie.all.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  flick.destroy
end
